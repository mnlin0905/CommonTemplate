...
/**
 * Created on 2018/1/6
 * function : viewPager禁止预加载
 *
 * @author ACChain
 */
public class DisallowPreloadViewPager extends ViewGroup {
    ...
    public DisallowPreloadViewPager(Context context) {
        super(context);
        initViewPager();
    }

    public DisallowPreloadViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
