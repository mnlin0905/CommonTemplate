...
/**
 * function---- TransactionRecordActivity
 * 交易列表
 * <p>
 * Created(Gradle default create) by ACChain on 2018/01/24 11:20:28 (+0000).
 */
@Route(path = ARouterConst.Activity_TransactionRecordActivity)
public class TransactionRecordActivity extends BaseActivity implements DisableScrollViewPager.ManageScrollInterface, DisallowClickTabLayout.ManageClickInterface, ListViewPopup.OnItemListener {
    ...
    protected void initFragment() {
        ...
        String[] stringArray = getResources().getStringArray(R.array.transaction_record_kind);
        for (int i = 0; i < stringArray.length; i++) {
            fragments.add((BaseFragment) ARouter.getInstance()
                    .build(ARouterConst.Fragment_TransactionRecordFragment)
