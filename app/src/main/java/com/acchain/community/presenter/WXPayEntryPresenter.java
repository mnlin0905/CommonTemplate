...
/**
 * function---- ConfirmAdoptOrderPresenter
 * <p>
 * Created(Gradle default create) by ACChain on 2018/01/16 05:50:46 (+0000).
 */
public class WXPayEntryPresenter extends BasePresenter<ConfirmAdoptOrderActivity> implements ConfirmAdoptOrderContract.Presenter{
    @Inject
