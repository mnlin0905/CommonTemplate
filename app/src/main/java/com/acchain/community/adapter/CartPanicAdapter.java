 ...
 * 购物车数据适配器
 */
public class CartPanicAdapter extends BaseExpandableListAdapter {
    private Context context;
    private List<StoreInfo> groups;
    private Map<Integer, List<CartPanicGoods.DataSetBean>> children;
    private CheckInterface checkInterface;
    private ModifyInterface modifyInterface;
    private GroupEditorInterface groupEditorInterface;

    public CartPanicAdapter(Context context) {
        this(context, null, null);
    }

    public CartPanicAdapter(Context context, List<StoreInfo> groups, Map<Integer, List<CartPanicGoods.DataSetBean>> children) {
        this.context = context;
        this.groups = groups;
        this.children = children;
    }

    public void setData(List<StoreInfo> groups, Map<Integer, List<CartPanicGoods.DataSetBean>> children) {
        this.groups = groups;
        this.children = children;
    ...
    public int getChildrenCount(int groupPosition) {
        if (groups != null) {
            ...
            List<CartPanicGoods.DataSetBean> dataSetBeans = children.get(id);
    ...
    public Object getChild(int groupPosition, int childPosition) {
        List<CartPanicGoods.DataSetBean> childs = children.get(groups.get(groupPosition).getId());
...
//        notifyDataSetChanged();
    ...
    public View getChildView(final int groupPosition, final int childPosition, final boolean isLastChild, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(context, R.layout.item_cart_panic_child, null);
        ...
        final CartPanicGoods.DataSetBean dataSetBean = (CartPanicGoods.DataSetBean) getChild(groupPosition, childPosition);
        if (dataSetBean != null) {
            CartPanicGoods.DataSetBean.ProductsBean products = dataSetBean.getProducts();
            ...
            childHolder.tvNowPrice.setText("￥" + (int) products.getSaleProductDiscountPrice() + "");
            ...
            childHolder.tvBeforePrice.setText("￥" + (int) products.getSaleProductPrice());
            childHolder.tvBeforePrice.setPaintFlags(Paint.STRIKE_THRU_TEXT_FLAG);
