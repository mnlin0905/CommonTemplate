...
public class SendRedPacketRecordAdapter extends RecyclerView.Adapter<SendRedPacketRecordAdapter.ViewHolder> {
    private List<SendRedPacketRecord.IssueRedEnvelopesListBean> listBeans;

    public SendRedPacketRecordAdapter(List<SendRedPacketRecord.IssueRedEnvelopesListBean> listBeans) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        SendRedPacketRecord.IssueRedEnvelopesListBean item = listBeans.get(position);
