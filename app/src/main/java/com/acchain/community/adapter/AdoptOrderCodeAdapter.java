...
public class AdoptOrderCodeAdapter extends RecyclerView.Adapter<AdoptOrderCodeAdapter.ViewHolder> {

    private Context context;
    private List<AdoptGoodDetail.DefaultAdoptCodeBean> adoptCodeBeans;

    public AdoptOrderCodeAdapter(Context context, List<AdoptGoodDetail.DefaultAdoptCodeBean> adoptCodeBeans) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_order_adopt_code, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.tvDelete.setOnClickListener(v -> {
            adoptCodeBeans.remove(position);
            notifyDataSetChanged();
