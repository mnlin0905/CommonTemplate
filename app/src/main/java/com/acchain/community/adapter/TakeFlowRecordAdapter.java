...
public class TakeFlowRecordAdapter extends RecyclerView.Adapter<TakeFlowRecordAdapter.ViewHolder> {

    private BaseActivity activity;
    private List<TransactionItemBean> datas;
    private BaseRecyclerViewHolder.OnViewClickListener listener;

    public TakeFlowRecordAdapter(BaseActivity activity, List<TransactionItemBean> datas, BaseRecyclerViewHolder.OnViewClickListener listener) {
    ...
    @Override
    public TakeFlowRecordAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(TakeFlowRecordAdapter.ViewHolder holder, int position) {
